                ...
                <Events>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            search through monsters fetched in real-time with user ids.
                            <hr />
                            <strong>Features:</strong>
                            <ul className="list-styles pt-1">
                            <li>Search through Monsters</li>
            ...
            <ImageEvent
                ...
                <div className="d-flex justify-content-between flex-column mt-1">
                    ...
                    <Accordion>
                        ...
                        <Accordion.Collapse eventKey="0" className="text-left">
                            <Card.Body>
                            <strong>Description:</strong> This is a full fledged e-commerce website,
                            for shopping.
                            <hr />
                            <strong>Features:</strong>
                            <ul className="list-styles pt-1">
